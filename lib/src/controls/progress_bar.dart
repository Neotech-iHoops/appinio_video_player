...
class _VideoProgressIndicatorState extends State<CustomVideoPlayerProgressBar> {
  ...
  void initState() {
    super.initState();
    widget.customVideoPlayerController.videoPlayerController.addListener(updateWidgetListener);
  }

  @override
  void deactivate() {
    widget.customVideoPlayerController.videoPlayerController.removeListener(updateWidgetListener);
    super.deactivate();
  }
  ...
  Widget build(BuildContext context) {
    if (widget
        .customVideoPlayerController.customVideoPlayerSettings.customVideoPlayerProgressBarSettings.showProgressBar) {
      Widget progressIndicator;
      if (widget.customVideoPlayerController.videoPlayerController.value.isInitialized) {
        final int duration = widget.customVideoPlayerController.videoPlayerController.value.duration.inMilliseconds;

        int maxBuffering = 0;
        for (DurationRange range in widget.customVideoPlayerController.videoPlayerController.value.buffered) {
        ...
        progressIndicator = ClipRRect(
          borderRadius: BorderRadius.circular(
            widget.customVideoPlayerController.customVideoPlayerSettings.customVideoPlayerProgressBarSettings
          ...
          child: Stack(
            children: [
              CustomVideoPlayerProgressIndicator(
                ...
                progressColor: widget.customVideoPlayerController.customVideoPlayerSettings
                    .customVideoPlayerProgressBarSettings.bufferedColor,
                backgroundColor: widget.customVideoPlayerController.customVideoPlayerSettings
                    .customVideoPlayerProgressBarSettings.backgroundColor,
              ),
      ...
      final Widget paddedProgressIndicator = Padding(
        padding: widget.customVideoPlayerController.customVideoPlayerSettings.customVideoPlayerProgressBarSettings
            .reachableProgressBarPadding,
